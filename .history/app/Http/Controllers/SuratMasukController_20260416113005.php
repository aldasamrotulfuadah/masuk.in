...
class SuratMasukController extends Controller
{
    ...
    public function store(Request $request){
        $request->validate([
            ...
            'lampiran'                        => 'required|file|mimes:pdf,jpg,jpeg,png,doc,docx|max:10240',
        ],[
        ...
        if ($request->hasFile('lampiran')) {
            ...
            $file->storeAs('public/uploads/lampiran', $namaFile, 'public');

            $suratmasuk->lampiran = 'publicuploads/lampiran/'.$namaFile;
        }
    ...
    public function edit($id){
     ...
     public function update(Request $request, $id){
        ...
        if ($request->hasFile('lampiran')) {
            ...
            $suratmasuk->lampiran = 'public/uploads/lampiran/'.$namaFile;
        }
        $suratmasuk->no_urut                            = $request->no_urut;
        $suratmasuk->tanggal_surat                      = $request->tanggal_surat;
        $suratmasuk->nomor_surat                        = $request->nomor_surat;
