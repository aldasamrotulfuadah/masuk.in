...
class SuratKeluarController extends Controller
{
    ...
    public function store(Request $request){
        $request->validate([
            ...
            'tanggal_dan_tempat_pelaksanaan.required'  => 'Tanggal dan Tempat Pelaksanaaan Tidak Boleh Kosong',
    ...
    public function edit($id){
     ...
     public function update(Request $request, $id){
        ...
        $suratkeluar->perihal                    = $request->perihal;
        $suratkeluar->sifat                      = $request->sifat;
        $suratkeluar->tanggal_dan_tempat_pelaksanaan = $request->tanggal_dan_tem;
        $suratkeluar->diteruskan_kepada          = $request->diteruskan_kepada;
        $suratkeluar->dengan_hormat_harap        = $request->dengan_hormat_harap;
        $suratkeluar->save();
