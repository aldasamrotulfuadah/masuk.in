...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('surat_masuks', function (Blueprint $table) {
            ...
            $table->enum('diteruskan_kepada',['Sekretaris','Kabid Ideologi Wawasan Kebangsaan, Ketahanan Eksosbud & Agama','Kabid Kewaspadaan Nasional & Penanganan Konflik', 'Kabid Politik Dalam Negeri & Ormas', 'Subid Ideologi Wasbang', 'Subid Ketahanan Eksosbud dan Agama', 'Subid Politik Dalam Negeri','Subid Organisasi Masyarakat','Subis','Subag Umun dan Kepegawaian', 'Subag Program Anggaran dan Keuangan']);
