                ...
                <div class="row mb-2">
                    <div class="col-xl-6">
                        ...
                        <select name="diteruskan_kepada" class="form-control @error('diteruskan_kepada') is-invalid @enderror">
                            ...
                            <option value="Kabid Politik Dalam Negeri & Ormas" {{ $surat->diteruskan_kepada == 'Kabid Politik Dalam Negeri & Ormas' ? 'selected' : ''}}>Kabid Politik Dalam Negeri & Ormas</option>
