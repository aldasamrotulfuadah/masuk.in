            ...
            <form action="{{ route('suratkeluarStore') }}" method="post">
                ...
                <div class="row mb-2">
                   ...
                   <div class="col-xl-6">
                        ...
                        <input type="text" name="tanggal_dan_tempat_pelaksanaan" class="form-control @error('tanggal_dan_tempat_pelaksanaan') is-invalid @enderror"  value="{{ old('tanggal_dan_tempat') }}">
